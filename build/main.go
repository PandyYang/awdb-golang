...
func main() {
	...
	for _, file := range []string{"/Users/pandy/go/src/awdb-golang/build/GeoLite2-ASN-Blocks-IPv4.csv", "/Users/pandy/go/src/awdb-golang/build/GeoLite2-ASN-Blocks-IPv6.csv"} {
		fh, err := os.Open(file)
		if err != nil {
			log.Fatal(err)
		}
