...
database. For TestExample, the city database needs many more small netblocks than
...
This is best demonstrated by an TestExample:
...
data. For TestExample, instead of repeating the string "United States" over and
...
Here is an TestExample of how the control byte may combine with the next byte to
tell us the type:
